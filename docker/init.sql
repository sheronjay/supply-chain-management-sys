...
-- =========================
INSERT INTO orders (order_id, customer_id, store_id, ordered_date, total_price, status) VALUES
-- August Orders
('ORD-0001','CUST-0001','ST-CMB-01','2025-08-01',  24300.00,'DELIVERED'),
('ORD-0002','CUST-0002','ST-CMB-01','2025-08-02',  19850.00,'DELIVERED'),
('ORD-0003','CUST-0003','ST-NGO-01','2025-08-03',   9600.00,'DELIVERED'),
('ORD-0004','CUST-0004','ST-NGO-01','2025-08-04',  14150.00,'DELIVERED'),
('ORD-0005','CUST-0005','ST-GAL-01','2025-08-05',  22000.00,'DELIVERED'),
('ORD-0006','CUST-0006','ST-GAL-01','2025-08-06',   6700.00,'DELIVERED'),
('ORD-0007','CUST-0007','ST-MAT-01','2025-08-07',  11900.00,'DELIVERED'),
('ORD-0008','CUST-0008','ST-MAT-01','2025-08-08',   9980.00,'DELIVERED'),
('ORD-0009','CUST-0009','ST-JAF-01','2025-08-09',  13450.00,'DELIVERED'),
('ORD-0010','CUST-0010','ST-TRI-01','2025-08-10',   7850.00,'DELIVERED'),
('ORD-0011','CUST-0011','ST-CMB-01','2025-08-15',   8250.00,'DELIVERED'),
('ORD-0012','CUST-0012','ST-NGO-01','2025-08-16',   9400.00,'DELIVERED'),
('ORD-0013','CUST-0013','ST-GAL-01','2025-08-17',  11000.00,'DELIVERED'),
('ORD-0014','CUST-0014','ST-MAT-01','2025-08-18',   5200.00,'DELIVERED'),
('ORD-0015','CUST-0015','ST-TRI-01','2025-08-19',  24600.00,'DELIVERED'),

-- September Orders
('ORD-0016','CUST-0001','ST-CMB-01','2025-09-01',   8350.00,'DELIVERED'),
('ORD-0017','CUST-0002','ST-CMB-01','2025-09-02',  10250.00,'DELIVERED'),
('ORD-0018','CUST-0003','ST-NGO-01','2025-09-03',   9100.00,'DELIVERED'),
('ORD-0019','CUST-0004','ST-NGO-01','2025-09-04',  15750.00,'DELIVERED'),
('ORD-0020','CUST-0005','ST-GAL-01','2025-09-05',   5800.00,'DELIVERED'),
('ORD-0021','CUST-0006','ST-GAL-01','2025-09-06',   7450.00,'DELIVERED'),
('ORD-0022','CUST-0007','ST-MAT-01','2025-09-07',  12000.00,'DELIVERED'),
('ORD-0023','CUST-0008','ST-MAT-01','2025-09-08',   8300.00,'DELIVERED'),
('ORD-0024','CUST-0009','ST-JAF-01','2025-09-09',   6000.00,'DELIVERED'),
('ORD-0025','CUST-0010','ST-TRI-01','2025-09-10',  19900.00,'DELIVERED'),
('ORD-0026','CUST-0011','ST-CMB-01','2025-09-15',   7700.00,'SCHEDULED'),
('ORD-0027','CUST-0012','ST-NGO-01','2025-09-16',   9600.00,'SCHEDULED'),
('ORD-0028','CUST-0013','ST-GAL-01','2025-09-17',  10550.00,'SCHEDULED'),
('ORD-0029','CUST-0014','ST-MAT-01','2025-09-18',  15200.00,'PLACED'),
('ORD-0030','CUST-0015','ST-TRI-01','2025-09-19',   8200.00,'PLACED'),

-- October Orders
('ORD-0031','CUST-0001','ST-CMB-01','2025-10-01',  22500.00,'DELIVERED'),
('ORD-0032','CUST-0002','ST-CMB-01','2025-10-01',  18750.00,'DELIVERED'),
('ORD-0033','CUST-0003','ST-NGO-01','2025-10-02',  12400.00,'DELIVERED'),
('ORD-0034','CUST-0004','ST-NGO-01','2025-10-02',   9800.00,'DELIVERED'),
('ORD-0035','CUST-0005','ST-GAL-01','2025-10-03',  16500.00,'DELIVERED'),
('ORD-0036','CUST-0006','ST-GAL-01','2025-10-03',  11200.00,'DELIVERED'),
('ORD-0037','CUST-0007','ST-MAT-01','2025-10-04',  13600.00,'DELIVERED'),
('ORD-0038','CUST-0008','ST-MAT-01','2025-10-04',   8900.00,'DELIVERED'),
('ORD-0039','CUST-0009','ST-JAF-01','2025-10-05',  21300.00,'DELIVERED'),
('ORD-0040','CUST-0010','ST-TRI-01','2025-10-05',  14700.00,'DELIVERED'),
('ORD-0041','CUST-0011','ST-CMB-01','2025-10-08',  17800.00,'DELIVERED'),
('ORD-0042','CUST-0012','ST-NGO-01','2025-10-09',  13200.00,'DELIVERED'),
('ORD-0043','CUST-0013','ST-GAL-01','2025-10-10',   9400.00,'SCHEDULED'),
('ORD-0044','CUST-0014','ST-MAT-01','2025-10-11',  12800.00,'SCHEDULED'),
('ORD-0045','CUST-0015','ST-TRI-01','2025-10-12',  15600.00,'SCHEDULED'),
('ORD-0046','CUST-0001','ST-CMB-01','2025-10-13',  19200.00,'SCHEDULED'),
('ORD-0047','CUST-0003','ST-NGO-01','2025-10-14',  11500.00,'SCHEDULED'),
('ORD-0048','CUST-0005','ST-GAL-01','2025-10-15',   8800.00,'PLACED'),
('ORD-0049','CUST-0007','ST-MAT-01','2025-10-15',  14200.00,'PLACED'),
('ORD-0050','CUST-0009','ST-JAF-01','2025-10-16',  16800.00,'PLACED'),
('ORD-0051','CUST-0010','ST-TRI-01','2025-10-17',  20500.00,'PLACED'),
('ORD-0052','CUST-0002','ST-CMB-01','2025-10-18',  15300.00,'PLACED'),
('ORD-0053','CUST-0004','ST-NGO-01','2025-10-19',  10800.00,'PLACED'),
('ORD-0054','CUST-0006','ST-GAL-01','2025-10-20',  18900.00,'PLACED'),
('ORD-0055','CUST-0008','ST-MAT-01','2025-10-21',  13400.00,'PLACED'),
('ORD-0056','CUST-0011','ST-CMB-01','2025-10-21',  22100.00,'PLACED'),
('ORD-0057','CUST-0012','ST-NGO-01','2025-10-22',  16700.00,'PLACED'),
('ORD-0058','CUST-0013','ST-GAL-01','2025-10-23',  12500.00,'PLACED'),
('ORD-0059','CUST-0014','ST-MAT-01','2025-10-23',  19600.00,'PLACED'),
('ORD-0060','CUST-0015','ST-TRI-01','2025-10-24',  14900.00,'PLACED'),
('ORD-0061','CUST-0001','ST-CMB-01','2025-10-24',  11200.00,'PLACED'),
('ORD-0062','CUST-0003','ST-NGO-01','2025-10-24',  17300.00,'PLACED'),
('ORD-0063','CUST-0005','ST-GAL-01','2025-10-25',  13800.00,'PLACED'),
('ORD-0064','CUST-0007','ST-MAT-01','2025-10-25',  16500.00,'PLACED'),
('ORD-0065','CUST-0009','ST-JAF-01','2025-10-25',  19200.00,'PLACED'),
('ORD-0066','CUST-0010','ST-TRI-01','2025-10-25',  14600.00,'PLACED'),
('ORD-0067','CUST-0002','ST-CMB-01','2025-10-25',  21400.00,'PLACED'),
('ORD-0068','CUST-0004','ST-NGO-01','2025-10-26',  12700.00,'PLACED'),
('ORD-0069','CUST-0006','ST-GAL-01','2025-10-26',  15900.00,'PLACED'),
('ORD-0070','CUST-0008','ST-MAT-01','2025-10-27',  18300.00,'PLACED');
